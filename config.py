...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id=0, num_pngs=2000); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
...
train = EasyDict(func='util_scripts.find_dir_latent_with_query_image', run_id=0, num_pngs=1); num_gpus = 1; desc = 'training_folder_latent_spaces-' + str(train.run_id)
